            ...
            <div className="wrapper">
                ...
                <div className="about-containers">
                    <div className="get-to-know-me">
                        ...
                        <div ref={myRef}><RoughNotation type="bracket" color="#319795" brackets={['left', 'right']} show={isVisible} strokeWidth='3px' animationDelay={2000} animationDuration={2500}><p>Nice to meet you my name is Laci and I am a highly ambitious, self-motivated, and driven Front-End Developer based in Hungary.</p>
